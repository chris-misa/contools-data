...
for (s in sizes) {
  ...
  meanDindContainerToTarget <- mean(dindContainerToTarget)
  meanDindToTarget <- mean(dindToTarget)
  cat(" Container in Dind to Target:", meanDindContainerToTarget, "(",sd(dindContainerToTarget),")\n")
  cat(" Dind to Target:             ", meanDindToTarget,"(",sd(dindToTarget),")\n")
  cat(" Difference:                 ", meanDindContainerToTarget-meanDindToTarget,"\n")
  cat(" Fraction:                   ", meanDindContainerToTarget/meanDindToTarget,"\n\n")
